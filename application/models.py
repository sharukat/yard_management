...
class Containers(models.Model):
    ...
    rsv         = models.BooleanField(default=False)
    ...
    reserved_to = models.CharField(max_length=100, null=True, blank=True)
    reservation_date = models.DateField(auto_now_add=False, null=True, blank=True)
    reserved_on = models.DateField(auto_now_add=False, null=True, blank=True)
